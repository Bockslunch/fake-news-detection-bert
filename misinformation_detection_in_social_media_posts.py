# -*- coding: utf-8 -*-
"""Misinformation Detection in Social Media Posts.ipynb
...
df_gossipcop_fake = pd.read_csv(f'{DATA_DIR}gossipcop_fake.csv', sep=',', on_bad_lines='skip')
df_gossipcop_fake['label'] = 1  # Fake
df_gossipcop_real = pd.read_csv(f'{DATA_DIR}gossipcop_real.csv', sep=',', on_bad_lines='skip')
df_gossipcop_real['label'] = 0  # Real
df_politifact_fake = pd.read_csv(f'{DATA_DIR}politifact_fake.csv', sep=',', on_bad_lines='skip')
df_politifact_fake['label'] = 1  # Fake
df_politifact_real = pd.read_csv(f'{DATA_DIR}politifact_real.csv', sep=',', on_bad_lines='skip')
